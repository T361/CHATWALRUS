...
-- =============================================================================
-- Table: learner_directory_rollups
-- =============================================================================
...
CREATE INDEX idx_learner_directory_rollups_company_name
  ON learner_directory_rollups(company_id, full_name, learner_id);
CREATE INDEX idx_learner_directory_rollups_status_name
  ON learner_directory_rollups(status, full_name, learner_id);
CREATE INDEX idx_learner_directory_rollups_company_status_name
  ON learner_directory_rollups(company_id, status, full_name, learner_id);
CREATE INDEX idx_learner_directory_rollups_active_courses
  ON learner_directory_rollups USING GIN(active_course_ids);
CREATE INDEX idx_learner_directory_rollups_email_lower
  ON learner_directory_rollups(LOWER(email));
CREATE INDEX idx_learner_directory_rollups_name_lower
  ON learner_directory_rollups(LOWER(full_name));

-- =============================================================================
-- Table: company_weekly_rollups
-- =============================================================================
...
CREATE INDEX idx_company_weekly_rollups_updated_at
...
CREATE INDEX idx_alerts_company_status_created_at ON alerts(company_id, status, created_at DESC);
...
CREATE INDEX idx_assignments_company_submitted_at ON assignments(company_id, submitted, submitted_at DESC);
